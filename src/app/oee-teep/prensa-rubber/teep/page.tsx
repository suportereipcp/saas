...
import { getFilteredMachinesTeep, getOeeFiltersData } from "@/actions/oee-metrics";
...
export default function PrensaRubberTeepPage() {
  ...
  const [cards, setCards] = useState<MachineTeepCard[]>([]);
  ...
  useEffect(() => {
    async function fetchCards() {
      ...
      try {
        const data = await getFilteredMachinesTeep({
          maquina,
          operador,
          periodo,
        ...
        console.error("Erro ao carregar TEEP por maquina:", error);
        setCards([]);
