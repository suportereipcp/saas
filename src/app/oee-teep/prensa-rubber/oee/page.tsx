...
import { BarChart3, Clock, Settings, Gauge, Filter, User } from "lucide-react";
  ...
  return (
    <div className="p-4 sm:p-5 space-y-4">
      ...
      <div className="grid grid-cols-4 gap-3 anim-d0">
        {[
          { label: "OEE Geral", value: metrics.oee, color: C.primary, colorEnd: C.primaryDark, icon: BarChart3 },
          { label: "Disponibilidade", value: metrics.disponibilidade, color: C.blue, colorEnd: C.blueDark, icon: Clock },
          { label: "Performance", value: metrics.performance, color: C.orange, colorEnd: C.orangeDark, icon: Settings },
          { label: "Qualidade", value: metrics.qualidade, color: C.primary, colorEnd: C.green, icon: Gauge },
        ].map((kpi) => {
          const Icon = kpi.icon;
          return (
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="pb-2 pt-4 px-5">
            <CardTitle className="text-xs font-bold uppercase tracking-widest text-foreground flex items-center gap-2">
              <BarChart3 className="w-4 h-4" /> Decomposição de Perdas
            </CardTitle>
          </CardHeader>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-b border-dashed hover:bg-blue-50/30 transition-colors">
                  ...
                  <td className="py-3.5 pl-4"><ProgressBar value={metrics.disponibilidade} color={C.blue} colorEnd={C.blueDark} /></td>
                </tr>
                ...
                <tr className="hover:bg-emerald-50/30 transition-colors">
                  ...
                  <td className="text-right px-3 py-3.5 font-mono font-bold text-foreground">100%</td>
                  <td className="py-3.5 pl-4"><ProgressBar value={metrics.qualidade} color={C.primary} colorEnd={C.green} /></td>
                </tr>
              </tbody>
            </table>
          </CardContent>
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader className="pb-1 pt-3 px-4">
              <CardTitle className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                Tendência de OEE ({periodo === "Personalizado" ? "Período selecionado" : periodo})
              </CardTitle>
            </CardHeader>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={metrics.trendData} margin={{ top: 20, right: 10, left: -20, bottom: 0 }}>
                    ...
                    <Area
                      ...
                      activeDot={{ r: 5, stroke: "#fff", strokeWidth: 2, fill: C.blue }}
              ...
              <div style={{ height: 165 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={metrics.paretoData} margin={{ top: 20, right: 10, left: -20, bottom: 0 }}>
                    ...
                    <Tooltip contentStyle={{ fontSize: 10, borderRadius: 8 }} />
                    <Bar dataKey="minutos" fill={C.blue} radius={[4, 4, 0, 0]} animationDuration={1200}>
                      <LabelList
                        dataKey="minutos"
                        position="top"
                        offset={6}
