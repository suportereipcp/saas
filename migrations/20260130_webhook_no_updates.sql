-- Versão SEM UPDATEs: Remove TODOS os UPDATEs para evitar problemas com RLS
-- Erros são registrados via RAISE WARNING (aparecem nos logs do PostgreSQL)
...
BEGIN
    ...
    BEGIN
        ...
        IF v_painel1 IS NOT NULL THEN
            ...
            IF (v_painel1->'cardsPedidos') IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.cards_pedidos;
            ...
            IF (v_painel1->'estoqueEstrategico') IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.estoque_produtos_estrategicos;
            ...
            IF (v_painel1->'estoqueAcabado') IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.balanceamento_estoque_acabado;
            ...
            IF (v_painel1->'performanceEntrega') IS NOT NULL THEN 
                TRUNCATE TABLE dashboards_pcp.performance_entrega;
            ...
            IF (v_painel1->'resumoPorItem') IS NOT NULL THEN 
                TRUNCATE TABLE dashboards_pcp.resumo_por_item;
            ...
            IF (v_painel1->'historicoPendencia') IS NOT NULL THEN 
                TRUNCATE TABLE dashboards_pcp.historico_pedidos;
            ...
            IF (v_painel1->'pedidosRecebidosSemana') IS NOT NULL THEN 
                TRUNCATE TABLE dashboards_pcp.pedidos_recebidos;
            ...
            IF v_bal IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.balanceamento_curva;
        ...
        IF v_painel2 IS NOT NULL THEN
            IF (v_painel2->'estoqueFundicao') IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.estoque_fundicao;
            ...
            IF (v_painel2->'producaoMaquinas') IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.media_prensa_injetora;
            ...
            IF (v_painel2->'comparativoMensal') IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.acompanhamento_diario;
        ...
        IF v_painel3 IS NOT NULL THEN
            IF (v_painel3->'carteiraME') IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.carteira_me;
            ...
            IF (v_painel3->'carteiraMI') IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.carteira_mi;
            ...
            IF (v_painel3->'faturamentoDiario') IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.faturamento_diario;
            ...
            IF (v_painel3->'vendasDiarias') IS NOT NULL THEN
                TRUNCATE TABLE dashboards_pcp.vendas_diaria;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            -- Captura erro e loga (apenas nos logs do PostgreSQL)
            v_error_msg := SQLERRM;
